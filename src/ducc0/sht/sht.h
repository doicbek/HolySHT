...
template<typename T> void synthesis_2d(
  ...
  size_t nthreads,
  SHT_mode mode);
// synthesis_general removed in minimal build (NUFFT dep)
...
template<typename T> void adjoint_synthesis_2d(
  ...
  size_t nthreads,
  SHT_mode mode);
// adjoint_synthesis_general removed in minimal build (NUFFT dep)
...
template<typename T> void analysis_2d(
  ...
  const cmav<double,1> &ringfactor, // (ntheta)
  size_t nthreads);
// pseudo_analysis_general removed in minimal build (NUFFT dep)
