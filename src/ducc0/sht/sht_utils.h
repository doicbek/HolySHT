...
// NUFFT-dependent helpers (resample_leg_CC_to_irregular and
// resample_leg_irregular_to_CC) are removed in this minimal build; the
// theta_interpol == true code path is unsupported.
#if 0
// NOTE: legi and lego may overlap, with identical start address and strides
...
#endif // disabled NUFFT-dependent helpers
